...
<body>
	...
	<table style="margin: 0 auto">
		<tr>
			<td>
				<form id=form_webcam action="./save_img.php" method="POST">
				<table class="shoot_table">
					<tr>
						<td class="shoot_cell" id=cover>
							<div class="filter" style="padding: 1rem">Webcam</div>
							<video autoplay="true" id="my_camera" style="height: 240px; width:320px;"></video>
							<canvas style="display:none;" id="my_canvas"></canvas>
							<img id="coverfilter" src="" style="height: 240px; width: 320px;">
						</td>
						<td class="shoot_cell">
						...
						<td class="button_shoot_cell" style="border: 1px solid black; width:200px; min-width:200px; background: linear-gradient(to bottom right, #a4ffa0, #b8cbff);">
							<input style="display: none" name="image_base" id="image_base" type="text" value="">
							<input style="display: none" name="action" value="webcam">
							<input type=button name="upload_snapshot_button" id="button_shoot" value="Take Photo" onclick="upload_snapshot();" disabled="">
						</td>
					</tr>
				</table>
				</form>
