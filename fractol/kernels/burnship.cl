...
kernel void ship(__global double *input,
				 __global int	  *results)
{
	...
	cr = 1.5 * (x - F_WIDTH / 2) / (double)(0.500 * (double)F_WIDTH * zoom) + h;
	ci = (y - F_HEIGHT / 2) / (double)(0.500 * (double)F_HEIGHT * zoom) + v;
