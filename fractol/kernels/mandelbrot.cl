...
kernel void mandel(__global double *input,
				   __global int	  *results)
{
	...
	pr = 1.5 * (x - F_WIDTH / 2) / (double)(0.500 * (double)F_WIDTH * zoom) + h;
	pi = (y - F_HEIGHT / 2) / (double)(0.500 * (double)F_HEIGHT * zoom) + v;
